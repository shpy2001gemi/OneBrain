...
> **OBKG là một đồ thị tri thức phi tập trung, mã hóa nhị phân, hoạt động như một sinh vật sống — nơi tri thức được sinh ra, tiến hóa, cạnh tranh, và chìm vào giấc ngủ đông khi không còn ai tìm đến.**

> [!NOTE]
> **"Chết" trong OBKG không phải "bị xóa".**
...
| **JanusGraph** | Adjacency-list-per-vertex trên KV store       | Gần nhất với cách OBKG lưu Vec<Bond></bond>   |
