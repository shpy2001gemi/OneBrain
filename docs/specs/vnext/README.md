...
| `FND-004` | [Golden/invalid foundation vectors](../../../src/test-vectors/vnext/foundation/canonical-v1.json) | Complete | 54 fixed vectors across CBOR, NFC, envelopes, signatures and 20 domains plus exact-boundary/property tests. |
...
| `KQL-006` | [Reunion Delta Join Profile v1](REUNION_DELTA_JOIN_PROFILE_V1.md) | Complete | Frontier-delta Affordance/Receptor joins over bounded local candidates; exact validated public admission and private proposal-only output. |
...
| `POMV-001` | [Use and Derivation Evidence Profile v1](USE_DERIVATION_EVIDENCE_PROFILE_V1.md) | Complete | Signed, authority-assessed behavioral/causal use records deduplicated by EventCID without truth, benefit, ranking or reward semantics. |
| `POMV-002` | [Metabolic Evidence View v1](METABOLIC_EVIDENCE_VIEW_V1.md) | Complete | Policy/frontier-relative cumulative EventCID roots separated from same-feed recent activity and local-private exposure telemetry; revisioned without truth, benefit or reward semantics. |
...
| `OBP-003` | [OBP Reconciliation Protocol Profile v1](OBP_RECONCILIATION_PROTOCOL_PROFILE_V1.md) | Complete | Canonical transcript/selector/namespace/disclosure/budget-bound Hello-to-Resume schema with full-CID manifests, caps and no authority/global-completion semantics. |
...
| `OBP-005` | [Persisted Reconciliation Journal v1](PERSISTED_RECONCILIATION_JOURNAL_V1.md) | Complete | Canonical memory/Redb session journal, context/checkpoint/MAC-bound continuation token, crash repair and durable retry/backpressure limits. |
